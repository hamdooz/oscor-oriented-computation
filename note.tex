...
The computational constructions in this note -- including the
localization-based module used to verify Theorem~4 and the direct-sum
constructions used for Theorems~1, 3 and 5 -- were developed in
consultation with Claude (Anthropic), an AI assistant, which also
assisted with drafting and formatting this manuscript in \LaTeX{} and
with iterative debugging of the accompanying Julia/OSCAR code during
development, including diagnosing incorrect function signatures and
API usage against the OSCAR documentation. All code was executed, and
all reported computational outputs were independently verified, by the
author in his own computing environment prior to inclusion in this
note; the author takes full responsibility for the correctness of all
mathematical claims and computations herein.
